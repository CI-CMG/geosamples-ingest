 ...
 */
public class TempQcIntervalPk implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    TempQcIntervalPk that = (TempQcIntervalPk) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(facilityCode, platformId, cruise, sample, deviceId, interval);
  }
}
