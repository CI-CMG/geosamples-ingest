...
public class ProviderCruiseController extends ProviderControllerBase<ProviderCruiseWriteView, CruiseView, ProviderCruiseSearchParameters, CruiseSearchParameters, Long, ProviderCruiseService> {
  ...
  public PagedItemsView<CruiseView> search(ProviderCruiseSearchParameters searchParameters, Authentication authentication) {
  ...
  public CruiseView create(ProviderCruiseWriteView view, Authentication authentication) {
  ...
  public CruiseView update(ProviderCruiseWriteView view, @PathVariable("id") Long id, Authentication authentication) {
