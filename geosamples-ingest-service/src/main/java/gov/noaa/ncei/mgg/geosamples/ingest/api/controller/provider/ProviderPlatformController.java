...
public class ProviderPlatformController extends ProviderControllerBase<ProviderPlatformView, PlatformView, ProviderPlatformSearchParameters, PlatformSearchParameters, Long, ProviderPlatformService> {
  ...
  public PagedItemsView<PlatformView> search(@Valid ProviderPlatformSearchParameters searchParameters, Authentication authentication) {
  ...
  public PlatformView create(@Valid @RequestBody ProviderPlatformView view, Authentication authentication) {
  ...
  public PlatformView update(@Valid @RequestBody ProviderPlatformView view, @PathVariable("id") Long id, Authentication authentication) {
