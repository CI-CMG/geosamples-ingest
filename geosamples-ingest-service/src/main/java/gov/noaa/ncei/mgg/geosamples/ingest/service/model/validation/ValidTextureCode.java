...
@Target(FIELD)
@Retention(RUNTIME)
@Constraint(validatedBy = ValidTextureCodeValidator.class)
@Documented
public @interface ValidTextureCode {

  String message() default "Invalid Texture Code";

  Class<?>[] groups() default {};

  Class<? extends Payload>[] payload() default {};

  class ValidTextureCodeValidator implements ConstraintValidator<ValidTextureCode, String> {

    private final CuratorsTextureRepository repository;

    @Autowired
    public ValidTextureCodeValidator(CuratorsTextureRepository repository) {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
      ...
      return repository.existsByTextureCode(value);
    }
  }
