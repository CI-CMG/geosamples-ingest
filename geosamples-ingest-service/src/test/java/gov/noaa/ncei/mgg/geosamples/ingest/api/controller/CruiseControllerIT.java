...
public class CruiseControllerIT {
  ...
  private static final CruiseService cruiseService = mock(CruiseService.class);

  @TestConfiguration
  static class TestConfig {
    @Primary
    @Bean
    public CruiseService testCruiseService() {
  ...
  @Test
  public void testReviewCruiseCAS() throws JoseException, IOException {
    createUserWithAuthority(Authorities.ROLE_CRUISE_UPDATE, false);
    ...
    ResponseEntity<String> response = restTemplate.exchange("/api/v1/cruise/review/1234", HttpMethod.PATCH, request, String.class);
    assertEquals(200, response.getStatusCodeValue());
  }

  @Test
  public void testReviewCruiseCASUnauthorized() throws JoseException, IOException {
  ...
  @Test
  public void testReviewCruiseToken() {
    final String tokenValue = createUserWithAuthority(Authorities.ROLE_CRUISE_UPDATE, true);
  ...
  @Test
  public void testReviewCruiseTokenUnauthorized() {
  ...
  @Test
  public void testReviewCruiseNoAuth() {
    HttpHeaders headers = new HttpHeaders();
    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
