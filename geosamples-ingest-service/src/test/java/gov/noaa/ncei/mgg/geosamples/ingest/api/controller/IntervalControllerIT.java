...
public class IntervalControllerIT {
  ...
  private static final IntervalService intervalService = mock(IntervalService.class);

  @TestConfiguration
  static class TestConfig {
    @Primary
    @Bean
    public IntervalService testIntervalService() {
  ...
  @Test
  public void testReviewIntervalCAS() throws JoseException, IOException {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/api/v1/interval/review/1", HttpMethod.PATCH, request, String.class);
    assertEquals(200, response.getStatusCodeValue());
  }

  @Test
  public void testReviewIntervalCASUnauthorized() throws JoseException, IOException {
  ...
  @Test
  public void testReviewIntervalToken() {
  ...
  @Test
  public void testReviewIntervalTokenUnauthorized() {
  ...
  @Test
  public void testReviewIntervalNoAuth() {
    HttpHeaders headers = new HttpHeaders();
    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
  ...
  public void testGetApprovalCAS() throws JoseException, IOException {
    ...
    ResponseEntity<String> response = restTemplate.exchange("/api/v1/interval/approval/1", HttpMethod.GET, new HttpEntity<>(headers), String.class);
    assertEquals(200, response.getStatusCodeValue());
  }
  ...
  public void testGetApprovalTokenUnauthorized() {
    final String tokenValue = createUserWithAuthority(Authorities.ROLE_SAMPLE_READ, true);
    assertNotNull(tokenValue);
