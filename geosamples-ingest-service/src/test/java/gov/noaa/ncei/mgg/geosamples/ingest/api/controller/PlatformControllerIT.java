...
public class PlatformControllerIT {
  ...
  private static final PlatformService service = mock(PlatformService.class);

  @TestConfiguration
  static class TestConfig {
    @Primary
    @Bean
    public PlatformService testPlatformService() {
      return service;
    }
  }
  ...
  @Test
  public void testReviewPlatformCAS() throws JoseException, IOException {
    createUserWithAuthority(Authorities.ROLE_PLATFORM_UPDATE, true);
    ...
    ResponseEntity<String> response = restTemplate.exchange("/api/v1/platform/review/1", HttpMethod.PATCH, request, String.class);
    assertEquals(200, response.getStatusCodeValue());
  }

  @Test
  public void testReviewPlatformCASUnauthorized() throws JoseException, IOException {
  ...
  @Test
  public void testReviewPlatformToken() {
    final String tokenValue = createUserWithAuthority(Authorities.ROLE_PLATFORM_UPDATE, true);
  ...
  @Test
  public void testReviewPlatformTokenUnauthorized() {
  ...
  @Test
  public void tetReviewPlatformNoAuth() {
    HttpHeaders headers = new HttpHeaders();
    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
