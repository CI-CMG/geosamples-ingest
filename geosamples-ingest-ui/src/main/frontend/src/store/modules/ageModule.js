...
export default {
  ...
  actions: {
    ...
    load({ commit }, id) {
      commit('loadRequest');
      return apiService.get(`/age/${encodeURIComponent(id)}`)
        .then(
          (response) => {
    ...
    save({ commit }, { provider, id }) {
      commit('saveRequest');
      const req = id ? () => apiService.put(`/age/${encodeURIComponent(id)}`, provider) : () => apiService.post('/age', provider);
      return req()
        .then(
          (response) => {
    ...
    delete({ commit }, id) {
      ...
      return apiService.delete(`/age/${encodeURIComponent(id)}`)
        .then(
          (response) => {
