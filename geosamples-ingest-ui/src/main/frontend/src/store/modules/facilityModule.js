...
export default {
  ...
  mutations: {
    ...
    setInstCode(state, instCode) {
      state.params.instCode = instCode;
    },
    setPage(state, page) {
      state.page = page;
    },
  ...
  actions: {
    ...
    searchPage({ commit, state }) {
      ...
      return apiService.get('/facility', {
        params:
          {
            ...params,
            page: state.page,
              ...
              if (data) {
                ...
                if (formErrors) {
                  ...
                  paths.forEach((path) => {
                    ...
                    commit('facilityForm/setTouched', { path, touched: false }, { root: true });
                    commit('facilityForm/setError', { path, error: message }, { root: true });
                  });
                }
              }
            }
