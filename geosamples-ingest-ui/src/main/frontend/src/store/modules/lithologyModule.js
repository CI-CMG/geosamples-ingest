...
export default {
  ...
  actions: {
    ...
    load({ commit }, id) {
      commit('loadRequest');
      return apiService.get(`/lithology/${encodeURIComponent(id)}`)
        .then(
          (response) => {
    ...
    save({ commit }, { provider, id }) {
      commit('saveRequest');
      const req = id ? () => apiService.put(`/lithology/${encodeURIComponent(id)}`, provider) : () => apiService.post('/lithology', provider);
      return req()
        .then(
          (response) => {
    ...
    delete({ commit }, id) {
      ...
      return apiService.delete(`/lithology/${encodeURIComponent(id)}`)
        .then(
          (response) => {
