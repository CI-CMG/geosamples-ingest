...
export default {
  ...
  actions: {
    ...
    load({ commit }, id) {
      commit('loadRequest');
      return apiService.get(`/munsell/${encodeURIComponent(id)}`)
        .then(
          (response) => {
    ...
    save({ commit }, { provider, id }) {
      commit('saveRequest');
      const req = id ? () => apiService.put(`/munsell/${encodeURIComponent(id)}`, provider) : () => apiService.post('/munsell', provider);
      return req()
        .then(
          (response) => {
    ...
    delete({ commit }, id) {
      ...
      return apiService.delete(`/munsell/${encodeURIComponent(id)}`)
        .then(
          (response) => {
