...
export default {
  ...
  mutations: {
    ...
    setProvince(state, province) {
      state.params.province = province;
    },
    setProvinceCode(state, provinceCode) {
      state.params.provinceCode = provinceCode;
    },
    setPage(state, page) {
      state.page = page;
    },
              ...
              if (data) {
                ...
                if (formErrors) {
                  ...
                  paths.forEach((path) => {
                    ...
                    commit('provinceForm/setTouched', { path, touched: false }, { root: true });
                    commit('provinceForm/setError', { path, error: message }, { root: true });
                  });
                }
              }
            }
