...
export default {
  ...
  mutations: {
    ...
    setRockLithology(state, rockLithology) {
      state.params.rockLithology = rockLithology;
    },
    setRockLithologyCode(state, rockLithologyCode) {
      state.params.rockLithologyCode = rockLithologyCode;
    },
    setPage(state, page) {
      state.page = page;
    },
  ...
  actions: {
    ...
    searchPage({ commit, state }) {
      ...
      return apiService.get('/rock-lithology', {
        params:
          {
            ...params,
            page: state.page,
              ...
              if (data) {
                ...
                if (formErrors) {
                  ...
                  paths.forEach((path) => {
                    ...
                    commit('rockLithologyForm/setTouched', { path, touched: false }, { root: true });
                    commit('rockLithologyForm/setError', { path, error: message }, { root: true });
                  });
                }
              }
            }
