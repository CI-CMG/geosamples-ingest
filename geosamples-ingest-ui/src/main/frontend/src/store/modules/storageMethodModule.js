...
export default {
  ...
  actions: {
    ...
    load({ commit }, id) {
      commit('loadRequest');
      return apiService.get(`/storage-method/${encodeURIComponent(id)}`)
        .then(
          (response) => {
    ...
    save({ commit }, { provider, id }) {
      commit('saveRequest');
      const req = id ? () => apiService.put(`/storage-method/${encodeURIComponent(id)}`, provider) : () => apiService.post('/storage-method', provider);
      return req()
        .then(
          (response) => {
    ...
    delete({ commit }, id) {
      ...
      return apiService.delete(`/storage-method/${encodeURIComponent(id)}`)
        .then(
          (response) => {
