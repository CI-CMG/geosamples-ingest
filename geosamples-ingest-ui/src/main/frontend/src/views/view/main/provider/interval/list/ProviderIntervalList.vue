<template>
  <InteractiveTable
    ...
    :is-approval="true"
    approval-text="Subsample/Interval Review"
  ...
  data() {
    return {
      tableFields: [
        ...
        { key: 'compCode1', label: 'Other Component Code 1' },
        { key: 'compCode2', label: 'Other Component Code 2' },
        { key: 'compCode3', label: 'Other Component Code 3' },
