...
export default {
  ...
  computed: {
    ...mapState('providerSample', ['deleting', 'loading', 'options', 'legOptions', 'loadingOptions', 'loadingLegs', 'saving', 'cruiseOptions', 'loadingCruises', 'loadingPlatformOptions', 'platformOptions']),
    ...mapState({
