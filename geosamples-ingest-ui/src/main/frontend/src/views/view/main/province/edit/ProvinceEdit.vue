<template>
  <div class="m-2">
    ...
    <b-breadcrumb :items="[
      ...
      { text: 'Physiographic Province', to: { name: 'ProvinceList' } },
      { text: 'Edit Physiographic Province', active: true },
    ]"/>
    ...
    <div v-if="ready">
      ...
      <b-modal ref="delete-modal" title="Delete Physiographic Province" ok-variant="danger" ok-title="Delete" @ok="doDelete">
        <p class="my-4">Are you sure you want to delete this physiographic province?</p>
      </b-modal>
