...
<!--    <b-breadcrumb :items="items"/>-->
    ...
    <div v-if="ready">
      ...
      <h1 v-if="isEdit" class="text-primary">Edit RockLithology - {{ getValue('rockLithology') }}</h1>
      <h1 v-else class="text-primary">Add New RockLithology</h1>

      <b-button v-if="isEdit" type="button" variant="danger" @click="doDelete" >Delete</b-button>

      <b-form @submit.prevent="saveForm" @reset.prevent="reset">

        <b-form-group v-if="!isEdit" label="RockLithology" :label-for="rockLithologyId">
          <b-form-input
            :id="rockLithologyId"
