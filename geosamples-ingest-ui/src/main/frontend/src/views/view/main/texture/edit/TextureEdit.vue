<template>
  <div class="m-2">
    ...
    <b-breadcrumb :items="[
      ...
      { text: 'Texture', to: { name: 'TextureList' } },
      { text: 'Edit Texture', active: true },
    ]"/>
    ...
    <div v-if="ready">
      ...
      <b-modal ref="delete-modal" title="Delete Texture" ok-variant="danger" ok-title="Delete" @ok="doDelete">
        <p class="my-4">Are you sure you want to delete this texture?</p>
      </b-modal>
